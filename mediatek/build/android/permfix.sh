...
mediatek/frameworks/featureoption/java/com/mediatek/featureoption/FeatureOption.java
kernel/drivers/net/wireless/mt592x/wlan/
mediatek/custom/common/uboot/logo/boot_logo
mediatek/external/bluetooth/blueangel/_bt_scripts/
mediatek/external/bluetooth/database/BTCatacherDB
"
