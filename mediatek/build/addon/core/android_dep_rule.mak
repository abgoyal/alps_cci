...
ifeq (yes,$(MTK_FOTA_SUPPORT))
  ifneq (yes,$(MTK_DM_APP))
    ifneq (yes,$(MTK_MDM_FUMO))
       $(call dep-err-common,please turn on MTK_DM_APP or MTK_MDM_FUMO else turn off MTK_FOTA_SUPPORT)
    endif
  endif
endif
##############################################################
...
ifneq ($(filter OP01%,$(strip $(OPTR_SPEC_SEG_DEF))),)
  ifneq ($(filter rel_customer_operator_%, $(MTK_RELEASE_PACKAGE)),rel_customer_operator_cmcc)
...
ifneq ($(filter OP02%,$(strip $(OPTR_SPEC_SEG_DEF))),)
  ifneq ($(filter rel_customer_operator_%, $(MTK_RELEASE_PACKAGE)),rel_customer_operator_cu)
...
ifneq ($(filter OP03%,$(strip $(OPTR_SPEC_SEG_DEF))),)
  ifneq ($(filter rel_customer_operator_%, $(MTK_RELEASE_PACKAGE)),rel_customer_operator_orange)
...
ifneq ($(filter OP02%, $(OPTR_SPEC_SEG_DEF)),)
   ifeq (yes, $(strip $(MTK_SIP_SUPPORT)))
      $(call dep-err-common, Please setOPTR_SPEC_SEG_DEF as none OP02 or set MTK_SIP_SUPPORT as no)
   endif
endif
...
ifeq ($(strip $(MTK_MDM_LAWMO)),yes)
  ifneq ($(strip $(MTK_MDM_APP)),yes)
   $(call dep-err-ona-offb,MTK_MDM_APP,MTK_MDM_LAWMO)
  endif
endif
ifeq ($(strip $(MTK_MDM_FUMO)),yes)
  ifneq ($(strip $(MTK_MDM_APP)),yes)
    $(call dep-err-ona-offb,MTK_MDM_APP,MTK_MDM_FUMO)
  endif
  ifneq ($(strip $(MTK_FOTA_SUPPORT)),yes)
    $(call dep-err-ona-offb,MTK_FOTA_SUPPORT,MTK_MDM_FUMO)
  endif
endif
ifeq ($(strip $(MTK_MDM_SCOMO)),yes)
  ifneq ($(strip $(MTK_MDM_APP)),yes)
   $(call dep-err-ona-offb,MTK_MDM_APP,MTK_MDM_SCOMO)
  endif
endif
#############################################################
...
ifeq (yes, $(strip $(MTK_GAMELOFT_LBC_ULC_CN_APP)))
  ifeq (yes, $(strip $(MTK_GAMELOFT_LBC_ULC_WW_APP)))
    $(call dep-err-offa-or-offb, MTK_GAMELOFT_LBC_ULC_WW_APP, MTK_GAMELOFT_LBC_ULC_CN_APP)
  endif
endif
