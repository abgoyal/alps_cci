...
my $FAT_ON_NAND					= $argv{"MTK_FAT_ON_NAND"};
...
my $OutputFolder="out/target/product/$PROJECT";
...
my @BR = (
	["$OutputFolder/MBR", [	[0x5,	0x0,0x0],
						[0x83,0x0,0x0],
						[0x83,0x0,0x0],
						[0xb,	0x0,0x0]]],
	["$OutputFolder/EBR1", [[0x83,0x0,0x0],
						[0x05,0x0,0x0]]],
	["$OutputFolder/EBR2", [[0x83,0x0,0x0]]]
);
