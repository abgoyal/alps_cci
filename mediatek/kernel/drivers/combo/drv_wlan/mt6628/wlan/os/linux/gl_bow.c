 ...
 * None.
 *
 * 01 17 2012 chinghwa.yu
 * [WCXRP00000065] Update BoW design and settings
 * [ALPS00115580] [Blocking][BlueTooth][FTP+HS]Init a File transfer From DUT(client) to server will cause DUT shut down and cause KE.
 * 
 * Change BOW event buffer size to 64 bytes
 *
 * 11 10 2011 cp.wu
