/*
** $Id: //Department/DaVinci/BRANCHES/MT6628_WIFI_DRIVER_V2_1/include/nic/wlan_def.h#1 $
*/
...
typedef struct _P2P_DEVICE_DESC_T {
    ...
    UINT_8              aucInterfaceAddr[MAC_ADDR_LEN]; /* Interface Address. Created tobe the same as Device Address, update if IF_IE found. */
