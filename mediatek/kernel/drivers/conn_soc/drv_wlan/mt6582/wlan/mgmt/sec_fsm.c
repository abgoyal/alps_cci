/*
** $Id: //Department/DaVinci/BRANCHES/MT6628_WIFI_DRIVER_V2_1/mgmt/sec_fsm.c#1 $
*/
    ...
    )
{
    ...
    if (prStaRec == NULL)
    {
        if (prMsduInfo->pfTxDoneHandler == secFsmEventDeauthTxDone)
        {
            if (prAdapter->rWifiVar.rAisSpecificBssInfo.fgCounterMeasure == TRUE)
            {
                DBGLOG(RSN, INFO, ("Start counter measure timeout timer...\n"));
