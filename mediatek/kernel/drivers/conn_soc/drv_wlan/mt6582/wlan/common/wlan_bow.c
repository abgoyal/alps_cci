/*
** $Id: //Department/DaVinci/BRANCHES/MT6628_WIFI_DRIVER_V2_1/common/wlan_bow.c#1 $
*/
...
#endif
        rlmDomainGetChnlList(prAdapter, BAND_2G4, MAX_BOW_NUMBER_OF_CHANNEL, &ucNumOfChannel, aucChannelList);
