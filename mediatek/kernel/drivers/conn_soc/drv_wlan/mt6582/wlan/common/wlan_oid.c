/*
** $Id: //Department/DaVinci/BRANCHES/MT6628_WIFI_DRIVER_V2_1/common/wlan_oid.c#1 $
*/
    ...
    )
{
    ...
    DBGLOG(INIT, INFO, ("[wifi] ExLen1 0x%p %d\n", pvQueryBuffer, u4BssidListExLen));
...
#endif
    DBGLOG(INIT, INFO, ("[wifi] ExLen2 %d\n", u4BssidListExLen));
    ...
    DBGLOG(INIT, INFO, ("[wifi] ExLen3 %d\n", u4BssidListExLen));
    ...
    *pu4QueryInfoLen = u4BssidListExLen;
    ...
    /* Clear the buffer */
    DBGLOG(INIT, INFO, ("[wifi] ExLen4 %d\n", u4BssidListExLen));
    ...
    if(kalIsConfigurationExist(prAdapter->prGlueInfo) == FALSE) {
        ...
        // zero
        DBGLOG(INIT, INFO, ("[wifi nvram] e 0x%p\n", prBssidEx));
    ...
    if(fgIsConfExist == TRUE) {
        ...
        if(u4ErrCode != 0) {
            ...
            // zero
            DBGLOG(INIT, INFO, ("[wifi nvram] v 0x%p %d\n",
                    prBssidEx, OFFSET_OF(PARAM_BSSID_EX_T, aucIEs)));
            kalMemZero(prBssidEx, OFFSET_OF(PARAM_BSSID_EX_T, aucIEs));
    ...
    )
{
    ...
    *pu4QueryInfoLen = sizeof(PARAM_SSID_T);
    ...
    DBGLOG(INIT, INFO, ("[wifi] q ssid 0x%p %d\n",
            prAssociatedSsid, sizeof(prAssociatedSsid->aucSsid)));
