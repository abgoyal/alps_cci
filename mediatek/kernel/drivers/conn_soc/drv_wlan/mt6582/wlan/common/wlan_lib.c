/*
** $Id: //Department/DaVinci/BRANCHES/MT6628_WIFI_DRIVER_V2_1/common/wlan_lib.c#1 $
*/
/*! \file   wlan_lib.c
...
** $Log: wlan_lib.c $
 *
 * 06 12 2012 eason.tsai
 * NULL
 * patch back for nvram convert from 6620 to 6628
 *
 * 06 11 2012 cp.wu
    ...
    )
{
    ...
    return u4Status;
        ...
        #else
        #error "Only MT6620/MT6628/MT657282 supports firmware download in an aggregated way"
