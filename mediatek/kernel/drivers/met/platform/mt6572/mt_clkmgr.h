...
typedef enum
{
    ...
    BEG_CG_GRP(CG_CTRL1, MT_CG_EFUSE_SW_CG),
                      ...
                      // MT_CG_PMIC_SW_CG_CONN,
                         ...
                         MT_CG_AUX_SW_CG_ADC,
    END_CG_GRP(CG_CTRL1, MT_CG_AUX_SW_CG_TP),
...
EXTERN int disable_clock(cg_clk_id id, const char *mod_name);
EXTERN int enable_clock(cg_clk_id id, const char *mod_name);
EXTERN int clock_is_on(cg_clk_id id);
EXTERN int enable_pll(pll_id id, const char *mod_name);
EXTERN int disable_pll(pll_id id, const char *mod_name);
EXTERN int enable_subsys(subsys_id id, const char *mod_name);
EXTERN int disable_subsys(subsys_id id, const char *mod_name);
...
EXTERN inline unsigned int grp_get_state(cg_grp_id id);
...
#define LSB2(x)      (((x) & 0x0001) ? (0) : (1))
#define LSB4(x)      (((x) & 0x0003) ? LSB2(x)  : (2 + LSB2((x)   >> 2)))
#define LSB8(x)      (((x) & 0x000F) ? LSB4(x)  : (4 + LSB4((x)   >> 4)))
#define LSB16(x)     (((x) & 0x00FF) ? LSB8(x)  : (8 + LSB8((x)   >> 8)))
#define LSB32(x)     (((x) & 0xFFFF) ? LSB16(x) : (16 + LSB16((x) >> 16)))

// alps/kernel/mediatek/platform/mt6572/kernel/drivers/uart/uart.c
#define MT_CG_PERI0_UART0       MT_CG_SYS_26M // TODO: remove it latter for build pass
#define MT_CG_PERI0_UART1       MT_CG_SYS_26M // TODO: remove it latter for build pass
#define MT_CG_PERI0_UART2       MT_CG_SYS_26M // TODO: remove it latter for build pass
#define MT_CG_PERI0_UART3       MT_CG_SYS_26M // TODO: remove it latter for build pass

// alps/kernel/mediatek/platform/mt6572/kernel/core/mt_auxadc.c
#define MT_CG_PERI1_AUXADC      MT_CG_SYS_26M // TODO: remove it latter for build pass

// alps/kernel/mediatek/platform/mt6572/kernel/core/camera_isp.c
#define MT_CG_IMAGE_CAM_SMI     MT_CG_SYS_26M // TODO: remove it latter for build pass
#define MT_CG_IMAGE_CAM_CAM     MT_CG_SYS_26M // TODO: remove it latter for build pass
#define MT_CG_IMAGE_SEN_TG      MT_CG_SYS_26M // TODO: remove it latter for build pass
#define MT_CG_IMAGE_SEN_CAM     MT_CG_SYS_26M // TODO: remove it latter for build pass
#define MT_CG_IMAGE_LARB3_SMI   MT_CG_SYS_26M // TODO: remove it latter for build pass
#define MT_CG_IMAGE_LARB4_SMI   MT_CG_SYS_26M // TODO: remove it latter for build pass
#define MT_CG_IMAGE_COMMN_SMI   MT_CG_SYS_26M // TODO: remove it latter for build pass
