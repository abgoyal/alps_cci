...
irqreturn_t PTP_ISR(int irq, void *dev_id)
{
    ...
    {   
        ...
        if( (temperature > 0x4b) && (temperature < 0xd3) ){
            ...
            // set PTP_VO_0 ~ PTP_VO_7 to PMIC
            ptp_print("MON_Volt Change? [%d]. PTP_MON_V0 = 0x%x\n", PTP_Change[0], PTP_MON_V[0]);
            ptp_print("MON_Volt Change? [%d]. PTP_MON_V1 = 0x%x\n", PTP_Change[1], PTP_MON_V[1]);
            ptp_print("MON_Volt Change? [%d]. PTP_MON_V2 = 0x%x\n", PTP_Change[2], PTP_MON_V[2]);
            ptp_print("MON_Volt Change? [%d]. PTP_MON_V3 = 0x%x\n", PTP_Change[3], PTP_MON_V[3]);
            ptp_print("MON_Volt Change? [%d]. PTP_MON_V4 = 0x%x\n", PTP_Change[4], PTP_MON_V[4]);
            ptp_print("MON_Volt Change? [%d]. PTP_MON_V5 = 0x%x\n", PTP_Change[5], PTP_MON_V[5]);
            ptp_print("MON_Volt Change? [%d]. PTP_MON_V6 = 0x%x\n", PTP_Change[6], PTP_MON_V[6]);
            ptp_print("MON_Volt Change? [%d]. PTP_MON_V7 = 0x%x\n", PTP_Change[7], PTP_MON_V[7]);
