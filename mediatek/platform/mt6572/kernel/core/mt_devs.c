...
/*=======================================================================*/
/* MT6589 USB Function Configuration List                                */
/*=======================================================================*/
...
static char *usb_ms_acm[] = {"usb_mass_storage", "acm"};
static char *usb_ms_adb_acm[] = {"usb_mass_storage", "adb", "acm"};
static char *usb_rndis_adb_acm[] = {"rndis", "adb", "acm"};
static struct android_usb_product usb_products[] = {
...
#ifdef CONFIG_USB_ANDROID_ACM    
    {
     .product_id = USB_RNDIS_ADB_ACM_PRODUCT_ID,
     .num_functions = ARRAY_SIZE(usb_rndis_adb_acm),
     .functions = (char **)usb_rndis_adb_acm,
    },
    {
    ...
    {
     .product_id = USB_MS_ACM_PRODUCT_ID,
     .num_functions = ARRAY_SIZE(usb_ms_acm),
     .functions = (char **)usb_ms_acm,
    },
#endif    
};

/*=======================================================================*/
/* MT6589 USB Function Platform Data                                     */
/*=======================================================================*/
...
// [MT6572] Need Porting
    ...
    /* remove serial number to match preloader setting*/
