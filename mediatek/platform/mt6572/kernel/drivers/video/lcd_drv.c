...
{
#ifdef MTK_LCDC_ENABLE_M4U
    m4u_alloc_mva(M4U_CLNTMOD_DISP, va, size, false, false, mva);
    m4u_insert_seq_range(M4U_CLNTMOD_DISP,
                                     *mva,
                                     *mva + size - 1,
                                     0);
#endif
...
//    }
    ...
    m4u_invalid_seq_range(M4U_CLNTMOD_DISP, mva, mva + size - 1);
    m4u_dealloc_mva(M4U_CLNTMOD_DISP, va, size, mva);
#endif
...
LCD_STATUS LCD_DumpM4U(){
    ...
    m4u_dump_info(M4U_CLNTMOD_DISP);
