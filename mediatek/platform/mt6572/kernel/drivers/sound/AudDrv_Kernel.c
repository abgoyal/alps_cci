...
{
    PRINTK_AUDDRV("++Auddrv_Add_MemIF_Counter, MEM_Type %d, Afe_WakeLock %d\n", MEM_Type, Afe_WakeLock);
    switch(MEM_Type)
    {
        case MEM_DL1:
            Afe_Mem_Pwr_on++;
    ...
    if(1 == Afe_WakeLock)
    {
        PRINTK_AUDDRV("Auddrv_Add_MemIF_Counter, wake_lock \n");
...
{
    PRINTK_AUDDRV("++Auddrv_Release_MemIF_Counter, MEM_Type %d, Afe_WakeLock %d\n", MEM_Type, Afe_WakeLock);
    switch(MEM_Type)
    {
        case MEM_DL1:
            Afe_Mem_Pwr_on--;
    ...
    if(Afe_WakeLock <= 0)
    {
        PRINTK_AUDDRV("Auddrv_Release_MemIF_Counter, wake_unlock \n");
