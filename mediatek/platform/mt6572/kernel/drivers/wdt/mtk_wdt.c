...
void wdt_set_mem_reserved_mode(bool enable)
{
...
void wdt_arch_reset(char mode)
{
	...
	DRV_WriteReg32(MTK_WDT_RESTART, MTK_WDT_RESTART_KEY);
	wdt_mode_val = DRV_Reg32(MTK_WDT_MODE);
	printk("wdt_arch_reset called MTK_WDT_MODE =%x, BROM_MAGIC =%x ! \n",wdt_mode_val, DRV_Reg32(SRAMROM_BASE + 0x28));
